...
const Collection = () => {
    ...
    const [showFilter, setrShowFilter] = useState(true);
    ...
    const sortProduct = () => {
        let fpCopy = [...filterProducts]; // Create a copy of the array
        ...
        switch (sortType) {
            ...
            default:
                applyFilter();
                return; // Exit early since applyFilter already sets the state
        }
        ...
        <div className="flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t">
            ...
            <div className="min-w-60">
                <p className="my-2 text-xl flex items-center cursor-pointer gap-2">
                    FILTERS
                    <img
                        onClick={() => setrShowFilter(!showFilter)}
